...
BVC: lectura desde Supabase; actualización del cache vía endpoints llamados por Lovable (Edge Function + pg_cron).
"""
...
# ---------------------------------------------------------------------------
# TRII - rating y total de votos (sin comentarios)
# ---------------------------------------------------------------------------
@app.get("/trii")
def get_trii() -> dict:
